 ...
 */
  ...
  public IssuedToken issueOneTimeToken(String deviceId) {
    ...
    return new IssuedToken(deviceId, token, hashHex, exp, enrollUrl, telemetryUrl);
  }
